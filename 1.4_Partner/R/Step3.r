...
result <- tryCatch({
  ...
  pmca_output <- run_db_query_andromeda(db_conn=conn, "SELECT * FROM #pmca_output ORDER BY pmca;", andromedaTableName = "cohort_tract_comorb")
  measures_output <- run_db_query_andromeda(db_conn=conn, "SELECT * FROM #measures_output;", andromedaTableName = "cohort_tract_comorb")
  race_condition_inputs <- run_db_query_andromeda(db_conn=conn, "SELECT * FROM #race_condition_inputs;", andromedaTableName = "cohort_tract_comorb")
