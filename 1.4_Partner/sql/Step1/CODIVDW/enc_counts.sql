  ...
  FROM (
  	SELECT l.@LINKID_COLUMN_VALUE AS linkid, e.PERSON_ID as patid, e.ENC_ID,
  		CASE WHEN ADATE >= '2017-1-1' AND ADATE < '2018-1-1' THEN 2017
	  		 ...
	  		 WHEN  ADATE >= '2020-1-1' AND ADATE < '2021-1-1' THEN 2020
	  		 WHEN  ADATE >= '2021-1-1' AND ADATE < '2022-1-1' THEN 2021
	  		 WHEN  ADATE >= '2022-1-1' AND ADATE < '2023-1-1' THEN 2022
  		END AS yr
  	FROM @SCHEMA.@ENCOUNTERS e
  	JOIN @SCHEMA.@LINK l on l.@PERSON_ID_PATID = e.PERSON_ID
  	WHERE e.ADATE >= '2017-1-1' AND e.ADATE < '2023-1-1'
