...
## choose partner
partner <- PartnerID # edit here
# 

# edit this once import file is set
# psm_inputs <- read_csv("combined/data/psm_inputs.csv")

psm_inputs_link <- read_csv(here("output", paste0("Step_", CODISTEP), paste0("step_3_result_", partner, ".csv"))) # edit here for file path
...
matched_data <- get_matches(match.test)
#View(matched_data)
