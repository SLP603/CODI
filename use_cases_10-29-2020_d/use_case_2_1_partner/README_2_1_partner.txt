...
Prior to the next step, make sure you receive the following outputs from DCC and place them in \use_case_2_1_partner\DCC_out\:

	- index_site_<ch/dh/kp>.csv
	
	
	
3. In \sql\2_1-step-3.sql, modify @file_path to where reference files are located (example "C:\\use_case_2_1_partner\\reference\\")
4. Run \sql\2_1-step-3.sql
5. Use bash/cmd to export outputs to csvs (name the output file so it ends with one of the following tags <ch/dh/kp> like "C:\use_case_2_1_partner\partner_out\cohort_CC_ch.csv")
...
6. In \r_scripts\R_2_1-step-4.R, edit partner <- "<ch/dh/kp>" to your partner name
7. In \r_scripts\R_2_1-step-4.R, edit psm_inputs_link <- read_csv("Partner_out/cohort_CC_<ch/dh/kp>.csv") to your partner name
8. Run \r_scripts\R_2_1-step-4.R
...
9. In \sql\2_1-step-6.sql, modify @file_path to where reference files are located (example "C:\\use_case_2_1_partner\\reference\\")
10. In \sql\2_1-step-6.sql, modify or comment out depending on your partner name: 
...
11. Run \sql\2_1-step-6.sql
12. Use bash/cmd to export outputs to csvs (name the output file so it ends with one of the following tags <ch/dh/kp> like "C:\use_case_2_1_partner\partner_out\cohort_CC_ch.csv")
